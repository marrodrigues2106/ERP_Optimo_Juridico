              ...
              <div className="ml-auto flex items-center gap-3">
                <Sheet>
                  ...
                  <SheetContent side="right" className="w-[400px] sm:w-[540px] flex flex-col">
                    <SheetHeader>
                      ...
                      <SheetDescription>
                        Seu assistente virtual com contexto sobre o sistema. Tire dúvidas
                        operacionais ou pesquise mais rápido.
                      </SheetDescription>
                    </SheetHeader>
                ...
                <Sheet>
                  ...
                  <SheetContent side="right">
                    ...
                    <div className="mt-6 flex flex-col items-center justify-center h-64 text-slate-500">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-xs font-bold text-white shrink-0 shadow-sm hover:opacity-90 outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all">
                      MR
                    </button>
                  </DropdownMenuTrigger>
